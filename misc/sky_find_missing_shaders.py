# Sora no Kiseki missing shader finder.  After running kuro_mdl_export_meshes.py, run this script
# and input the name of the game you want to target, and it will search the database
# (by default 'sky_shaders.csv', set below) to generate a report
# of any shaders that do not exist in the target game.  Requires Python 3.10 or newer.
#
# Requires sky_find_similar_shaders.py, place in the same folder.
...
try:
    ...
    from sky_find_similar_shaders import Shader_db
