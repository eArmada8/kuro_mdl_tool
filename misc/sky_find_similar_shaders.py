# Sky 1st shader finder.  Give the filename of a shader e.g. 'chr_cloth#a8b9eb0baf9ad2dc'
# and it will search the database (by default 'ys_x_shaders.csv', set below) to generate a report
# of the other switches, ranked by similarity.  Requires Python 3.10 or newer.
#
# Requires sky_shaders.csv, obtain from
# https://raw.githubusercontent.com/eArmada8/kuro_mdl_tool/master/misc/sky_shaders.csv
#
